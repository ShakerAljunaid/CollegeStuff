Public Class Practical_PCNT

    Private Sub Logic_design_Practical_BindingNavigatorSaveItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Logic_design_Practical_BindingNavigatorSaveItem.Click
        Me.Validate()
        Me.Logic_design_Practical_BindingSource.EndEdit()
        Me.TableAdapterManager.UpdateAll(Me.College_stuffDataSet)

    End Sub

    Private Sub Logic_practical__Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'College_stuffDataSet._Logic_design_Practical_' table. You can move, or remove it, as needed.
        Me.Logic_design_Practical_TableAdapter.Fill(Me.College_stuffDataSet._Logic_design_Practical_)
    ...
    Private Sub Logic_practical__FormClosing(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles MyBase.FormClosing
        Try
    ...
    Private Sub TextBox1_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TextBox1.TextChanged
        Logic_design_Practical_BindingSource.Filter = "title2 like '%" + TextBox1.Text + "%'"
