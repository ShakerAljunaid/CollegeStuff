Public Class Notes
    ...
    Private Sub NotesBindingNavigatorSaveItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NotesBindingNavigatorSaveItem.Click
        Me.Validate()
    ...
    Private Sub Notes_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'College_stuffDataSet.Notes' table. You can move, or remove it, as needed.
        Me.NotesTableAdapter.Fill(Me.College_stuffDataSet.Notes)
    ...
    Private Sub TextBox1_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TextBox1.TextChanged
        NotesBindingSource.Filter = "title like '%" + TextBox1.Text + "%'"
    End Sub
    ...
    Private Sub Notes_FormClosing(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles MyBase.FormClosing
        Try
