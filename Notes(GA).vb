Public Class Notes_GA

    Private Sub Math_NotesBindingNavigatorSaveItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Math_NotesBindingNavigatorSaveItem.Click
        Me.Validate()
        Me.Math_NotesBindingSource.EndEdit()
        Me.TableAdapterManager.UpdateAll(Me.College_stuffDataSet)

    End Sub

    Private Sub Math_notes_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'College_stuffDataSet.Math_Notes' table. You can move, or remove it, as needed.
        Me.Math_NotesTableAdapter.Fill(Me.College_stuffDataSet.Math_Notes)
    ...
    Private Sub TextBox1_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TextBox1.TextChanged
        Math_NotesBindingSource.Filter = "title like '%" + TextBox1.Text + "%'"
    End Sub
    ...
    Private Sub Math_notes_FormClosing(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles MyBase.FormClosing
        Try
